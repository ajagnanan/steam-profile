...
class SteamProfileFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    def async_get_options_flow(
        ...
        return SteamProfileOptionsFlowHandler(config_entry)
...
class SteamProfileOptionsFlowHandler(config_entries.OptionsFlow):
